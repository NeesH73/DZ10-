...
namespace Tymakov11
{
    public class Bank2
    {
        ...
        internal Queue<BankTransaction> Transactions
        ...
        internal Bank2(double account_balance)
        {
        ...
        internal Bank2(Type account_type)
        {
        ...
        internal Bank2(double account_balance, Type account_type)
        {
            this.account_balance = account_balance;
            this.account_type = account_type;
            account_number = generationnumber;
